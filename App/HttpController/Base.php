...
{
    protected $view;
    protected $session_login_key = 'is_login';
    ...
    public function onRequest(?string $action): ?bool
    {
        ...
        if ($this->session()->exist($this->session_login_key)) {
            $this->admin_info = json_encode($this->session()->get($this->session_login_key), true);
        } else {
